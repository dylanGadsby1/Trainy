...
if services:
    ...
    urls = [
        f"https://data.rtt.io/gb-nr/service/{encoded_uid}",
        f"https://data.rtt.io/gb-nr/service?uniqueIdentity={encoded_uid}",
        f"https://data.rtt.io/gb-nr/service?uid={encoded_uid}",
    ]
