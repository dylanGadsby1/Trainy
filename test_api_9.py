...
# test variations of service url
uid = "gb-nr:C82647:2026-08-02"
print(test_url(f"https://data.rtt.io/gb-nr/service/{uid}"))
print(test_url(f"https://data.rtt.io/gb-nr/service/gb-nr/C82647/2026/08/02"))
print(test_url(f"https://data.rtt.io/gb-nr/service/gb-nr/C82647/2026-08-02"))
print(test_url(f"https://data.rtt.io/gb-nr/service/C82647"))
print(test_url(f"https://data.rtt.io/gb-nr/service/C82647/2026/08/02"))
